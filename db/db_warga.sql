...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 23 Feb 2020 pada 10.58
...
INSERT INTO `mutasi_keluar` (`id_mutasi`, `id_pdd`, `alamat_mutasi`, `desa_kelurahan_mutasi`, `kabupaten_kota_mutasi`, `provinsi_mutasi`, `negara_mutasi`, `dusun_mutasi`, `rt_mutasi`, `rw_mutasi`, `kode_pos_mutasi`, `tanggal_pindah`, `alasan_pindah`, `jenis_pindah`, `created_at`, `updated_at`, `kecamatan_mutasi`) VALUES
...
INSERT INTO `mutasi_masuk` (`id_mutasi_masuk`, `id_pdd`, `id_keluarga`, `dusun_masuk`, `rt_masuk`, `rw_masuk`, `alamat_asal`, `tanggal_pindah`, `alasan_pindah`, `jenis_kepindahan`) VALUES
...
INSERT INTO `tbl_kelahiran` (`id_kelahiran`, `tgl_kelahiran`, `nama_bayi`, `jk`, `berat_bayi`, `panjang_bayi`, `nama_ayah`, `nama_ibu`, `lokasi_lahir`, `tempat_lahir`, `id_keluarga`, `penolong`, `id_pdd`, `id_surat`) VALUES
...
INSERT INTO `tbl_meninggal` (`id_meninggal`, `tgl_meninggal`, `sebab`, `id_pdd`, `tempat_kematian`, `nama_pelapor`, `hubungan_pelapor`, `id_surat`) VALUES
...
(1, 'otakcoding', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin di aplikasi pendataan warga', 'Admin', 'kebun jahe', 'binjai', 'medan', 'sumatera utara', 'Indonesia', '001', '002', '2020-02-23 09:50:01', '2017-10-19 06:31:17'),
...
(13, 'Kasi Pemerintahan', 'kasi_pemerintahan', '827ccb0eea8a706c4c34a16891f84e7b', 'Kasi Pemerintahan', 'Kasi_Pemerintahan', 'Dukuhdalem', 'Ciawigebang', 'Kuningan', 'Jawa Barat', 'Indonesia', '', '', '2020-02-23 09:58:12', '0000-00-00 00:00:00');
...
INSERT INTO `warga_has_kartu_keluarga` (`id_pdd`, `id_keluarga`) VALUES
(1, 11),
(9, 11),
(12, 11),
(15, 11),
...
ALTER TABLE `warga_has_kartu_keluarga`
  ADD UNIQUE KEY `id_pdd` (`id_pdd`),
  ADD KEY `id_penduduk` (`id_pdd`,`id_keluarga`),
...
--
ALTER TABLE `warga`
  MODIFY `id_pdd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `kartu_keluarga`
  ADD CONSTRAINT `kartu_keluarga_ibfk_1` FOREIGN KEY (`id_kepala_keluarga`) REFERENCES `warga` (`id_pdd`),
...
--
ALTER TABLE `tbl_meninggal`
  ADD CONSTRAINT `tbl_meninggal_ibfk_1` FOREIGN KEY (`id_pdd`) REFERENCES `warga` (`id_pdd`);
COMMIT;
