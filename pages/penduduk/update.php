...
$query = "UPDATE warga SET nik_warga = '$nik_warga', nama_warga = '$nama_warga', tempat_lahir_warga = '$tempat_lahir_warga', tanggal_lahir_warga = '$tanggal_lahir_warga', jenis_kelamin_warga = '$jenis_kelamin_warga', alamat_ktp_warga = '$alamat_ktp_warga', alamat_warga = '$alamat_warga', desa_kelurahan_warga = '$desa_kelurahan_warga', kecamatan_warga = '$kecamatan_warga', kabupaten_kota_warga = '$kabupaten_kota_warga', provinsi_warga = '$provinsi_warga', negara_warga = '$negara_warga', dusun_warga = '$dusun_warga',rt_warga = '$rt_warga', rw_warga = '$rw_warga', agama_warga = '$agama_warga', pendidikan_terakhir_warga = '$pendidikan_terakhir_warga', pekerjaan_warga = '$pekerjaan_warga', status_warga = '$status_warga', updated_at = CURRENT_TIMESTAMP WHERE warga.id_pdd = $id_pdd;";
