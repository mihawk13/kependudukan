...
foreach ($data as $pdd) {
    ...
    $pdf->cell(30, 7, strtoupper($pdd['nik']), 1, 0, 'C');
    ...
    $pdf->cell(55, 7, substr(strtoupper($pdd['alamat']), 0, 20), 1, 0, 'L');
    ...
    $pdf->cell(30, 7, strtoupper($pdd['pendidikan_terakhir']), 1, 0, 'C');
    $pdf->cell(50, 7, strtoupper($pdd['pekerjaan']), 1, 1, 'C');
}
