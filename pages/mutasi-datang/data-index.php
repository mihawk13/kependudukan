...
$query = "SELECT *,nik,nama,jenis_kelamin,pendidikan_terakhir,pekerjaan, status_perkawinan, TIMESTAMPDIFF(YEAR, `tanggal_lahir`, CURDATE()) AS usia_mutasi FROM penduduk JOIN mutasi_masuk ON penduduk.id_pdd = mutasi_masuk.id_pdd";
