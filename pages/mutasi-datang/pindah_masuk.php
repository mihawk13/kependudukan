...
$query3 = "SELECT * FROM warga order by id_pdd DESC";
...
<table class="table table-striped table-middle">
  ...
  <tr>
    ...
    <td>
      ...
      <input type="hidden" class="form-control input-md" name="id_pdd" id="id_pdd" value="<?php echo $kode;?>" size="30" placeholder="ID warga" required/>
