...
$query = "INSERT INTO mutasi (id_mutasi, id_keluarga, id_pdd, alamat_mutasi, desa_kelurahan_mutasi, kecamatan_mutasi, kabupaten_kota_mutasi, provinsi_mutasi, negara_mutasi, rt_mutasi, rw_mutasi, kode_pos_mutasi, tanggal_pindah, alasan_pindah, jenis_pindah, id_user, created_at, updated_at) VALUES (NULL,'$id_keluarga','$id_pdd','$alamat_mutasi','$desa_kelurahan_mutasi', '$kecamatan_mutasi', '$kabupaten_kota_mutasi', '$provinsi_mutasi', '$negara_mutasi', '$rt_mutasi', '$rw_mutasi', '$kode_pos_mutasi','$tanggal_pindah','$alasan_pindah','$jenis_pindah','$id_user',CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";
...
//if ($hasil == true) {
  ...
  //$query_delete = "DELETE FROM warga WHERE id_pdd = $id_pdd";

  //$hasil_delete = mysqli_query($db, $query_delete);
//}

if ($hasil == true){
	$query_update = "UPDATE warga SET status_warga ='Pindah keluar' where id_pdd= $id_pdd";
...
if ($hasil == true) {
  ...
  echo "<script>window.alert('Mutasi warga gagal!'); window.location.href='../mutasi/pindah_keluar.php?id_pdd=".$id_pdd."'</script>";
}
