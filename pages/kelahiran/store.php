...
$query2 = "INSERT INTO warga (id_pdd, nik_warga, nama_warga, tempat_lahir_warga, tanggal_lahir_warga, jenis_kelamin_warga, alamat_ktp_warga, alamat_warga, desa_kelurahan_warga, kecamatan_warga, kabupaten_kota_warga, provinsi_warga, negara_warga, dusun_warga, rt_warga, rw_warga, agama_warga, pendidikan_terakhir_warga, pekerjaan_warga, status_perkawinan_warga, status_warga, id_user, created_at, updated_at) VALUES ('$id_pdd', '$nik_sementara', '$nama_bayi', '$tempat_lahir', '$tgl_kelahiran', '$jk', '$alamat_kk', '$alamat_kk', '$desa_kk', 'Ciawigebang', 'Kuningan', 'Jawa Barat', 'INDONESIA', '$dusun_kk', '$rt_kk', '$rw_kk', 'Islam', '-', '-', 'Belum Kawin', 'Tinggal Tetap', '-', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";
...
$query="INSERT INTO tbl_kelahiran (id_kelahiran, tgl_kelahiran, nama_bayi, jk, berat_bayi, panjang_bayi, nama_ayah, nama_ibu, lokasi_lahir, tempat_lahir, id_keluarga, penolong, id_pdd, id_surat) VALUES ('NULL','$tgl_kelahiran','$nama_bayi', '$jk','$berat_bayi','$panjang_bayi','$nama_ayah','$nama_ibu','$lokasi_lahir','$tempat_lahir','$nama_kepala_keluarga','$penolong','$id_pdd','NULL')";

$sql="INSERT INTO warga_has_kartu_keluarga (id_pdd, id_keluarga) VALUES ('$id_pdd','$id_keluarga')";
