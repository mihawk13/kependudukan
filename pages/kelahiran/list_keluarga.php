...
//ambil data kk
$query_keluarga = "SELECT penduduk.nama, kartu_keluarga.id_keluarga, kartu_keluarga.nomor_kk, penduduk.alamat, penduduk.desa_kelurahan, penduduk.rt, penduduk.rw FROM penduduk
JOIN kartu_keluarga ON penduduk.id_pdd=kartu_keluarga.id_kepala_keluarga";
...
//ambil penduduk
$query = "SELECT nama,nik,id_pdd FROM penduduk";
