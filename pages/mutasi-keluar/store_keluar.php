...
$query = "INSERT INTO mutasi_keluar (id_mutasi, id_pdd, alamat_mutasi, desa_kelurahan_mutasi, kecamatan_mutasi, kabupaten_kota_mutasi, provinsi_mutasi, negara_mutasi, dusun_mutasi, rt_mutasi, rw_mutasi, kode_pos_mutasi, tanggal_pindah, alasan_pindah, jenis_pindah, created_at, updated_at) VALUES (NULL,'$id_pdd','$alamat_mutasi','$desa_kelurahan_mutasi', '$kecamatan_mutasi', '$kabupaten_kota_mutasi', '$provinsi_mutasi', '$negara_mutasi','$dusun_mutasi', '$rt_mutasi', '$rw_mutasi', '$kode_pos_mutasi','$tanggal_pindah','$alasan_pindah','$jenis_pindah',CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";
...
if ($hasil_update == true) {
  # echo "sukses";
   ...
   echo "<script>window.alert('Mutasi warga gagal!'); window.location.href='../mutasi-keluar/pindah_keluar.php?id_pdd=".$id_pdd."'</script>";
  # echo "Gagal";
