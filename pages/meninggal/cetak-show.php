...
//Isi Surat
$jenis = '         Yang bertanda tangan dibawah ini Kepala Desa ' . $desa . ', Kecamatan ' . $kecamatan . ', Kabupaten ' . $kabupaten . ', Provinsi ' . $provinsi . ' menerangkan bahwa telah meninggal dunia seorang penduduk dengan data sebagai berikut:';
