...
$query="INSERT INTO tbl_meninggal (id_meninggal, tgl_meninggal, sebab, id_pdd, tempat_kematian, nama_pelapor, hubungan_pelapor, id_surat) VALUES 
('','$tgl_kematian','$penyebab','$id_pdd','$tempat_kematian','pelapor','$hub_pelapor','')";

# echo "<br>".$query;

$query2="UPDATE warga SET status_warga = 'Meninggal' WHERE id_pdd = $id_pdd";
