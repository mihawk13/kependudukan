...
//ambil warga
 $query_warga = "SELECT nama_warga,nik_warga,id_pdd FROM warga WHERE status_warga<>'Meninggal'";
# $query_warga = "SELECT warga.nama_warga, warga.nik_warga, warga.id_pdd FROM warga JOIN tbl_meninggal WHERE warga.id_pdd<>tbl_meninggal.id_pdd";
