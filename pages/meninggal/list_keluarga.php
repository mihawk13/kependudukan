...
//ambil data kk
$query_keluarga = "SELECT penduduk.nama, kartu_keluarga.nomor_keluarga FROM penduduk JOIN kartu_keluarga ON penduduk.id_pdd=kartu_keluarga.id_kepala_keluarga ";
