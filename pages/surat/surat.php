...
$tmp_surat = mysqli_query($db,$sql_nomer_surat);
...
?>
    ...
    <link  href="../../assets/css/jquery-ui-1.8.19.custom.css" rel="stylesheet" type="text/css" />
<div class="top-bar">
...
$(function(){
	...
	$("#form").submit(function(){
		...
		var id_pdd = $("#no_ktp").val();
		 // cetak surat 
	//	 $.post("template_surat/surat_ket.php",{nama_surat:nama_surat,no_surat:nomer_surat,data:input,ttd:t_tangan,nip:nip,id_pdd:id_pdd},function(data){
		...
		$("#nama_pemohon").html("<span style='text-transform:uppercase;text-decoration:underline'>"+$("#nama").val()+"</span>");		
			...
			OK: function(){
				...
				$("#surat_tampil").show();
				$("#cetak").show();
				$.post(url,{jenis_surat:jenis_surat,no_surat:nomer_surat,nama_surat:nama_surat,data:input,ttd:t_tangan,nip:nip,id_pdd:id_pdd,nama_warga:nama_warga},function(data){
					if(data == 1){
					//window.print();
				//	$("#cetak").click();
						}
