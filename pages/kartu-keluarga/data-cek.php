...
$query="SELECT warga.id_pdd, warga.nik_warga, warga.nama_warga, kartu_keluarga.nomor_keluarga, kartu_keluarga.id_kepala_keluarga FROM warga JOIN kartu_keluarga WHERE kartu_keluarga.id_kepala_keluarga=warga.id_pdd";
